...
export const LAUNCHER_BROWSER_HOST_KIND = "fame-codex-launcher";
export const LAUNCHER_BROWSER_IDLE_URL = "data:text/html;charset=utf-8,%3C!doctype%20html%3E%3Chtml%3E%3Chead%3E%3Cmeta%20charset%3D%22utf-8%22%3E%3Ctitle%3EFame%20Codex%3C%2Ftitle%3E%3C%2Fhead%3E%3Cbody%3E%3C%2Fbody%3E%3C%2Fhtml%3E#fame-codex-browser-host";
...
function assertDescriptorShape(value: unknown): LauncherBrowserHostDescriptor {
  ...
  const expectedPartition = descriptor.profile === "development"
    ? "persist:fame-codex-dev-chatgpt"
    : "persist:fame-codex-chatgpt";
