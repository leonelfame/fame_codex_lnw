...
const en = {
  ...
  mcpStepOneBody: "Create one tunnel and one runtime key with Tunnels Read + Use. They stay on your computer.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  mcpStepOneBody: "创建一个 Tunnel 和一个具有 Tunnels Read + Use 权限的运行时密钥。它们只保存在本机。",
