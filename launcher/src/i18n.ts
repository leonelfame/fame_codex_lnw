...
const en = {
  ...
  biggerContextBody: "Warning: splits every DEV context across three staging messages plus one final execution message. This sends more ChatGPT requests and may increase the chance of rate limits or a temporary cooldown. Disabled by default.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "警告：每个 DEV 上下文会拆分为三条暂存消息和一条最终执行消息。这会向 ChatGPT 发送更多请求，并可能提高触发速率限制或临时冷却的概率。默认关闭。",
